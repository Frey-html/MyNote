...
HD_PWD='C:/Users/Frey/Desktop/大二下/计组/计组实验/Lab0 Vivado介绍和模块封装（学生版）/OExp00/Water_LED/Water_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Water_LED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Water_LED.tcl -notrace
